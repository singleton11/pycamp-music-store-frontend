...
// Show dialog for select payment method for buy item
export const PAYMENT_METHOD_SHOW_SELECT_DIALOG =
  'PAYMENT_METHOD_SHOW_SELECT_DIALOG';

// Hide dialog for select payment method for buy item
export const PAYMENT_METHOD_HIDE_SELECT_DIALOG =
